...
func main() {
	...
	messages := []*schema.Message{
		...
		{
			Role:    schema.User,
			Content: "使用WebFetch 查下一下 https://kepu.cctv.cn/2026/01/14/ARTIsRPSQythLMojVjGe5pTW260114.shtml?spm=C31626.PIMmlo1ewBPI.ERJURLsGrBD9.1 看下返回什么。然后再用 WebSearch 搜一下”春节“”，看下返回什么",
		},
	}
